import { ContentPosition, ContentScope, InlineElement, TextSection } from 'roosterjs-types';
import { ContentTraverser, isTextualInlineElement, matchWhiteSpaces } from 'roosterjs-dom';
