...
describe('handleTable', () => {
    ...
    it('Block format on TABLE and TD is respected', () => {
        ...
        expect(parent.innerHTML).toBe(
            '<table style="direction: rtl; margin-left: auto; text-align: center; line-height: 2; white-space: pre;"><tbody><tr><td style="width: 100px; height: 200px; direction: ltr; text-align: left; line-height: 1; white-space: normal;"></td></tr></tbody></table>'
        );
    });
