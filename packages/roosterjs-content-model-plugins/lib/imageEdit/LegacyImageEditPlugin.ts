...
/**
 * Legacy ImageEdit plugin handles the following image editing features:
 * - Resize image
 * - Crop image
 * - Rotate image
 * - Flip image
 *
 * This is the original ImageEdit implementation. It is kept for backward compatibility and is used
 * when the `ImageEditV2` experimental feature is disabled. When the feature is enabled,
 * `ImageEditPluginV2` is used instead.
 */
export class LegacyImageEditPlugin implements ImageEditor, EditorPlugin {
    public editor: IEditor | null = null;
    protected shadowSpan: HTMLSpanElement | null = null;
    protected selectedImage: HTMLImageElement | null = null;
    protected wrapper: HTMLSpanElement | null = null;
    protected imageEditInfo: ImageMetadataFormat | null = null;
    protected imageHTMLOptions: ImageHtmlOptions | null = null;
    protected dndHelpers: DragAndDropHelper<DragAndDropContext, any>[] = [];
    protected clonedImage: HTMLImageElement | null = null;
    protected lastSrc: string | null = null;
    protected wasImageResized: boolean = false;
    protected isCropMode: boolean = false;
    protected resizers: HTMLDivElement[] = [];
    protected rotators: HTMLDivElement[] = [];
    protected croppers: HTMLDivElement[] = [];
    protected zoomScale: number = 1;
    protected disposer: (() => void) | null = null;
    ...
    protected isImageSelection(target: Node): target is HTMLElement {
        return (
