            ...
            blocks: [
                {
                            ...
                            cells: [
                                {
                                    ...
                                    format: {
                                        textAlign: 'center',
                                        whiteSpace: 'nowrap',
                                        borderTop: '0.5pt solid rgb(0,0,0)',
                                        borderRight: '0.5pt solid rgb(0,0,0)',
                                        borderBottom: '0.5pt solid rgb(0,0,0)',
                                        borderLeft: '0.5pt solid rgb(0,0,0)',
                    ...
                    blockType: 'Table',
                    format: { width: '157pt', useBorderBox: true, borderCollapse: true },
                    dataset: {},
                },
                {
                    segments: [
