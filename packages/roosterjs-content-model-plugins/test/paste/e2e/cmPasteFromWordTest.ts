...
import {
    wordClipboardContent1,
    wordClipboardContent2,
    wordClipboardContent3,
    wordClipboardContent4,
} from './htmlTemplates/wordClipboardContent';
...
describe(ID, () => {
                            ...
                            cells: [
                                {
                                    ...
                                    format: {
                                        ...
                                        borderBottom: '1pt solid currentcolor',
                                        borderLeft: '1pt solid currentcolor',
                                        paddingTop: '0in',
                                        paddingRight: '5.4pt',
                                        paddingBottom: '0in',
                                        paddingLeft: '5.4pt',
                                ...
                                },
                                {
                                    ...
                                    format: {
                                        ...
                                        borderRight: '1pt solid currentcolor',
                                        borderBottom: '1pt solid currentcolor',
                                        borderLeft: 'medium none currentcolor',
                                        paddingTop: '0in',
                                        paddingRight: '5.4pt',
                                        paddingBottom: '0in',
                                        paddingLeft: '5.4pt',
    ...
    itChromeOnly('E2E remove bullet padding if margin is in cm units', () => {
        paste(editor, wordClipboardContent3);
                            ...
                            cells: [
                                {
                                    ...
                                    blocks: [
                                        ...
                                        },
                                        {
                                            ...
                                            blockType: 'BlockGroup',
                                            format: { lineHeight: 'normal', marginBottom: '0cm' },
                                            blockGroupType: 'ListItem',
                                            blocks: [
                                                {
                                                    isImplicit: true,
                                    ...
                                    format: {
                                        borderTop: '1pt solid rgb(163, 163, 163)',
                                        borderRight: '1pt solid rgb(163, 163, 163)',
                                        borderBottom: '1pt solid rgb(163, 163, 163)',
                                        borderLeft: '1pt solid rgb(163, 163, 163)',
                                        paddingTop: '4pt',
                                        paddingRight: '4pt',
                                        paddingBottom: '4pt',
                                        paddingLeft: '4pt',
    ...
    itChromeOnly('E2E paragraphs that are handled as list and with unneeded styles', () => {
        paste(editor, wordClipboardContent4);
        const model = editor.getContentModelCopy('disconnected');
        ...
        expectEqual(model, {
            ...
            blocks: [
                ...
                },
                {
                    segments: [
                        ...
                        },
                        {
                            ...
                            segmentType: 'Text',
                            format: { textColor: 'rgb(0, 0, 0)' },
                            link: { format: { name: '_Int_hqC0OfdX' }, dataset: {} },
                        },
                        {
                            text: '■■■■■■■■■■■■■■■■■■■',
                            segmentType: 'Text',
                    ...
                    segments: [
                        {
                            text: '■■■■■■',
                            segmentType: 'Text',
                            format: { textColor: 'black', italic: true },
                        },
                    ],
                    blockType: 'Paragraph',
                    format: { marginTop: '1em', marginBottom: '1em' },
                    ...
                    segments: [
                        {
                            ...
                            segmentType: 'Text',
                            format: {
                                fontFamily: '"Aptos Light", sans-serif',
                ...
                },
                {
                    ...
                    blockType: 'Paragraph',
                    format: {},
                    decorator: { tagName: 'h2', format: { fontSize: '1.5em', fontWeight: 'bold' } },
                },
                {
                    segments: [
                        {
