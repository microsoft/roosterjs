...
describe('fragmentHandler', () => {
    ...
    describe('HTML with fragment from Word Online', () => {
        ...
        describe('fragments contains both list and text', () => {
            ...
            it('fragments contains text, list and table that consist of list', () => {
                runTest(
                    '<html><body><div class="OutlineElement"><div class="TableContainer"><table><tbody><tr><td><div><div class="OutlineElement"><p><span><span>asdfasdf</span></span><span></span></p></div></div></td><td><div><div class="OutlineElement"><p><span><span>asdfasdf222</span></span><span></span></p></div></div></td></tr><tr><td><div><div class="ListContainerWrapper"><ul><li role="listitem" data-aria-level="1" class="OutlineElement">A</li></ul></div></div></td><td><div><div class="ListContainerWrapper"><ul><li role="listitem" data-aria-level="1" class="OutlineElement">A</li></ul></div></div></td></tr></tbody></table></div></div></body></html>',
                    true,
                    '<div class="OutlineElement"><div class="TableContainer"><table><tbody><tr><td><div><div class="OutlineElement"><p><span><span>asdfasdf</span></span><span></span></p></div></div></td><td><div><div class="OutlineElement"><p><span><span>asdfasdf222</span></span><span></span></p></div></div></td></tr><tr><td><div><div class="ListContainerWrapper"><ul><li role="listitem" data-aria-level="1" class="OutlineElement">A</li></ul></div></div></td><td><div><div class="ListContainerWrapper"><ul><li role="listitem" data-aria-level="1" class="OutlineElement">A</li></ul></div></div></td></tr></tbody></table></div></div>'
                );
            });
        });
