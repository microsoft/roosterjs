...
import domToContentModel from 'roosterjs-content-model/lib/domToModel/domToContentModel';
import { ContentModelEditorCore } from 'roosterjs-content-model/lib/publicTypes';
import {
    applyFormat,
    applyTextStyle,
...
export const createPasteFragment: CreatePasteFragment = (
    ...
    ///// This is a copy of createPasteFragment for prototyping CopyPaste with Content Model
    //------------------- Start ------------------------
    if (!clipboardData) {
        return null;
    }
    ...
    /// ---------------------- End of copy original createPasteContent ----------------------
    ...
    const contentModelEvent = <ContentModelBeforePasteEvent>{
        clipboardData,
        eventType: PluginEventType.ContentModelBeforePaste,
        htmlAttributes: event.htmlAttributes,
        model,
    };

    core.api.triggerEvent(core, (contentModelEvent as any) as PluginEvent, true /*broadcast*/);
