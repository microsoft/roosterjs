...
import {
    ...
    removeDisplayFlex,
} from '../../../lib/editorCommand/createModelFromHtml/sanitizeGeneralProcessor';

describe('sanitizeGeneralProcessor', () => {
    ...
    it('Empty element, DIV', () => {
        ...
        const pasteGeneralProcessor = createSanitizeGeneralProcessor({
