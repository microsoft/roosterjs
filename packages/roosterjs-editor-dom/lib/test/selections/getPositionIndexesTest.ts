// import { getSavedSelection, getRangeFromSavedSelection } from '../../utils/savedSelection';
...
//             const savedSelection = getSavedSelection(initialRange, element);
//             const resultingRange = getRangeFromSavedSelection(savedSelection, element);
...
//             expect(getSavedSelection(initialRange, div)).toEqual({
//                 startPath: [0, 0],
//                 endPath: [0, 5],
//             });
...
//             // Act
//             const savedSelection = getSavedSelection(initialRange, div);
//             const divCopy = dom(div.outerHTML);
//             const resultingRange = getRangeFromSavedSelection(savedSelection, divCopy);
