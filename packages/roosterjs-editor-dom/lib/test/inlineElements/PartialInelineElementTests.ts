...
function createPartialInlineElementWithContent(
    ...
    startOffset: number,
    endOffset: number
): [PartialInlineElement, NodeInlineElement, NodeBlockElement, HTMLElement] {
...
function createPartialInlineElementWithDiv(
    ...
    startOffset: number,
    endOffset: number
): [PartialInlineElement, NodeInlineElement, NodeBlockElement] {
    ...
    let startPosition = startOffset
        ...
        : null;
    let endPosition = endOffset ? new Position(testDiv.firstChild.lastChild, endOffset) : null;
...
describe('PartialInlineElement getEndPosition()', () => {
    ...
    function runTest(input: [string, number, number], output: number) {
        ...
        // Assert
        expect(endPosition).toEqual(new Position(testDiv.firstChild.firstChild, output));
    }
