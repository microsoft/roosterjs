import * as applyTableFormat from 'roosterjs-content-model-dom/lib/modelApi/table/applyTableFormat';
...
import * as normalizeTable from 'roosterjs-content-model-dom/lib/modelApi/table/normalizeTable';
