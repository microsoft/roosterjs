...
export { toggleBold, ToggleBoldOptions } from './publicApi/segment/toggleBold';
export { toggleItalic, ToggleItalicOptions } from './publicApi/segment/toggleItalic';
export { toggleUnderline, ToggleUnderlineOptions } from './publicApi/segment/toggleUnderline';
