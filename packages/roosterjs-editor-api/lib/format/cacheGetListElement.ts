...
export default function cacheGetListElement(editor: Editor, event?: PluginEvent, listType?: string): Element {
...
export function getListElementAtNode(editor: Editor, node: Node, listType: string): Element {
    let startElement =
