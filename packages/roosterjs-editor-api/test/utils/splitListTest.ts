...
describe('splitListTest()', () => {
    ...
    it('split List', () => {
        ...
        expect(editor.getContent()).toBe(
            '<div><ol id="OL"><li>item 1</li><li>item 2</li></ol><ol><li id="focusNode">item 3</li><li>item 4</li></ol></div>'
        );
    });
    ...
    it('split deep level List', () => {
        ...
        // Assert
        expect(editor.getContent()).toBe(
            '<div><ol id="OL"><li>Item 1</li><ol style="list-style-type: lower-alpha;"><li>Upper Level Item 1</li><li>Upper Level Item 2</li></ol></ol><ol><ol style="list-style-type: lower-alpha;"><li id="focusNode">Upper Level Item 3</li><li>Upper Level Item 4</li></ol><li>Item 2</li><li>Item 3</li></ol></div>'
        );
    });
    ...
    it('split deep level List 2', () => {
        ...
        // Assert
        expect(editor.getContent()).toBe(
            '<div><ol id="OL"><li>1</li><ol style="list-style-type: lower-alpha;"><ol style="list-style-type: lower-roman;"><li>1</li><li>2</li></ol></ol></ol><ol><ol style="list-style-type: lower-alpha;"><ol style="list-style-type: lower-roman;"><li id="focusNode">3</li><li>4</li></ol></ol></ol></div>'
        );
    });
});
