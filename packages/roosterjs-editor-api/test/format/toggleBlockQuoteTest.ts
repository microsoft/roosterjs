...
describe('toggleBlockQuote', () => {
    ...
    it('Multi-level list', () => {
        runTest(
            ...
            '<div><ol><li><span>a</span></li><ol><li>b</li><ol><li>c</li></ol></ol></ol><blockquote><ol><ol><ol><li>d</li></ol><li>e</li></ol><li>f</li></ol><div>g</div></blockquote></div><div>h</div>'
        );
    });
    ...
    it('Two multilevel lists', () => {
        runTest(
            ...
            '<div><ol><li><span>a</span></li><ol><li>b</li><ol><li>c</li></ol></ol></ol></div><blockquote><div><ol><ol><ol><li>d</li></ol><li>e</li></ol><li>f</li></ol><div>g</div></div><div>h</div><div><ol><li><span>a</span></li><ol><li>b</li><ol><li>c</li></ol></ol></ol></div></blockquote><div><ol><ol><ol><li>d</li></ol><li>e</li></ol><li>f</li></ol></div>'
        );
    });
    ...
    it('Whole list selected', () => {
        runTest(
            ...
            '<blockquote>0<div><ol><li><span>a</span></li><ol><li>b</li><ol><li>c</li><li>d</li></ol><li>e</li></ol><li>f</li></ol><div>g</div></div></blockquote><div>h</div>'
        );
    });
    ...
    it('Mixed table and list', () => {
        runTest(
            ...
            '<div><table><tbody><tr><td>test1</td><td>test2</td></tr><tr><td><blockquote>test3</blockquote></td><td><blockquote>test4</blockquote></td></tr></tbody></table></div><blockquote><div>test5</div><div><ol><li>test6</li></ol></div></blockquote><div><ol><li>test7</li></ol></div>'
        );
    });
