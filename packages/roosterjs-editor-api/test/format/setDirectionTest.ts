...
describe('setDirection()', () => {
    ...
    let originalContent =
        '<div id="text" style="font-size: 12pt; font-family: Calibri, Arial, Helvetica, sans-serif;">text</div>';
    let editor: IEditor;
    ...
    it('sets the direction', () => {
        ...
        expect(editor.getContent()).toBe(
            '<div id="text" style="font-size: 12pt; font-family: Calibri, Arial, Helvetica, sans-serif; text-align: right;" dir="rtl">text</div>'
        );
    });
});
