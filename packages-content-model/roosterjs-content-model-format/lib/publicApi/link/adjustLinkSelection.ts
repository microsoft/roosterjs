...
import { getSelectedSegments, setSelection } from 'roosterjs-content-model-editor';
 ...
 */
export function adjustLinkSelection(editor: IContentModelEditor): [string, string | null] {
    let text = '';
