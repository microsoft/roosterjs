...
import { getFirstSelectedListItem, updateListMetadata } from 'roosterjs-content-model-editor';
 ...
 */
export function setListStyle(editor: IContentModelEditor, style: ListMetadataFormat) {
    editor.focus();
