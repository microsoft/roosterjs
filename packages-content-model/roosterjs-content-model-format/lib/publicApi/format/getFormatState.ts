import { getSelectionRootNode } from 'roosterjs-content-model-editor';
import { retrieveModelFormatState } from '../../modelApi/format/retrieveModelFormatState';
import type { ContentModelBlockGroup, DomToModelContext } from 'roosterjs-content-model-types';
import type { ContentModelFormatState, IContentModelEditor } from 'roosterjs-content-model-editor';
 ...
 */
export function getFormatState(editor: IContentModelEditor): ContentModelFormatState {
