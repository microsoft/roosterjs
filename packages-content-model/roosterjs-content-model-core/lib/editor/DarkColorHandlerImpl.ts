...
import { parseColor } from '../modelApi/common/parseColor';
 ...
 * @internal
 */
export class DarkColorHandlerImpl implements ColorManager {
    private knownColors: Record<string, Readonly<ColorPair>> = {};
        ...
        ColorAttributeName.forEach((names, i) => {
            ...
            if (color && color != 'inherit') {
                element.style.setProperty(
                    ...
                    this.registerColor(color, toDarkMode)
                );
            }
        });
    }
