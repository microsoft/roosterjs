...
export function createPasteGeneralProcessor(
    ...
    const allowedTags = AllowedTags.concat(options.additionalAllowedTagsInLowerCase);
    const disallowedTags = DisallowedTags.concat(options.additionalDisallowedTagsInLowerCase);
