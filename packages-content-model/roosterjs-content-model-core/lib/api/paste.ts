import { BeforePasteEvent } from '../publicTypes/event/BeforePasteEvent';
import { formatWithContentModel } from './formatWithContentModel';
import { PluginEventData } from '../publicTypes/event/PluginEvent';
import { setPendingFormat } from '../utils/pendingFormat';
import {
...
function triggerPluginEventAndCreatePasteFragment(
    ...
    clipboardData: ClipboardData,
    pasteType: PasteType,
    eventData: PluginEventData<'beforePaste'>,
    ...
    if (pasteType !== 'asPlainText') {
        pluginEvent = editor.triggerPluginEvent('beforePaste', event, true /* broadcast */);
    }
