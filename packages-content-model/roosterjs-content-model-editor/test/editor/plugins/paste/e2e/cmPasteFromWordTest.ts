...
describe(ID, () => {
                ...
                Object({
                    ...
                    segments: [
                        Object({
                            ...
                            format: Object({ fontFamily: 'Calibri, sans-serif', fontSize: '11pt' }),
                        }),
                    ],
                    segmentFormat: undefined,
                    blockType: 'Paragraph',
                    format: Object({}),
                    decorator: Object({ tagName: 'p', format: Object({}) }),
                }),
                Object({
                    cachedElement: undefined,
                    isImplicit: undefined,
    ...
    it('E2E Content with Table, borders and text using windowtext', () => {
        clipboardData.rawHtml =
