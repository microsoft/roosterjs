...
describe('wordOnlineHandler', () => {
    ...
    it('Table with merged cells.', () => {
        ...
        if (Browser.isFirefox) {
            delete result.blocks[0].blocks[0].blocks[0].rows[0].cells[0].format.borderTop;
            delete result.blocks[0].blocks[0].blocks[0].rows[0].cells[0].format.borderRight;
            delete result.blocks[0].blocks[0].blocks[0].rows[0].cells[0].format.borderLeft;

            delete result.blocks[0].blocks[0].blocks[0].rows[0].cells[1].format.borderTop;
            delete result.blocks[0].blocks[0].blocks[0].rows[0].cells[1].format.borderRight;
            delete result.blocks[0].blocks[0].blocks[0].rows[0].cells[1].format.borderLeft;

            delete result.blocks[0].blocks[0].blocks[0].rows[1].cells[0].format.borderRight;
            delete result.blocks[0].blocks[0].blocks[0].rows[1].cells[0].format.borderLeft;

            delete result.blocks[0].blocks[0].blocks[0].rows[1].cells[1].format.borderRight;
            delete result.blocks[0].blocks[0].blocks[0].rows[1].cells[1].format.borderLeft;
        }
