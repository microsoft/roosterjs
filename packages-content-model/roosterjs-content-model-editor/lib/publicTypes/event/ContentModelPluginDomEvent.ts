...
export interface ContentModelPluginDomEventBase<
    TEventType extends PluginEventType,
 ...
 */
export interface ContentModelPluginKeyPressEvent
    extends ContentModelPluginDomEventBase<'keyPress', KeyboardEvent> {}
 ...
 */
export type ContentModelPluginMouseEvent =
 ...
 */
export type ContentModelPluginKeyboardEvent =
    | ContentModelPluginKeyDownEvent
    | ContentModelPluginKeyPressEvent
 ...
 */
export type ContentModelPluginDomEvent =
    | ContentModelPluginCompositionEvent
    | ContentModelPluginMouseEvent
    | ContentModelPluginKeyboardEvent
