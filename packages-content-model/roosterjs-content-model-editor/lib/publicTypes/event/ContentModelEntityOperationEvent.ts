...
import { EntityOperation } from '../parameter/FormatWithContentModelContext';
 ...
 */
export interface ContentModelEntityOperationEvent extends BasePluginEvent<'entityOperation'> {
    /**
