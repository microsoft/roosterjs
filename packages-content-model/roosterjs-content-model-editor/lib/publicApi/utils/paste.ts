...
import { ChangeSource, GetContentMode, PasteType } from 'roosterjs-editor-types';
...
function createBeforePasteEventData(
    ...
    clipboardData: ClipboardData,
    pasteType: PasteType
): ContentModelPluginEventData<'beforePaste'> {
...
function triggerPluginEventAndCreatePasteFragment(
    ...
    eventData: ContentModelPluginEventData<'beforePaste'>,
