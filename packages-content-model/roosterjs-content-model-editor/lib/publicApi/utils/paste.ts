...
export default function paste(
    ...
    const pasteModel = domToContentModel(event.fragment, {
...
function createBeforePasteEventData(
    ...
    const eventData: ContentModelBeforePasteEventData = {
        clipboardData,
...
function createBeforePasteEvent(
    ...
    const event = editor.triggerPluginEvent(
