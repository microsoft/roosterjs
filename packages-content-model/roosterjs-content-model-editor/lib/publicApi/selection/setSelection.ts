...
/**
 * Select selection of the given Content Model to be the range of start/end area
 * @param group The Content Model root to set selection to
 * @param start First selected area
 * @param end Last selected area
 */
