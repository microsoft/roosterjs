...
import { updateTableCellMetadata, updateTableMetadata } from 'roosterjs-content-model-editor';
import type {
    BorderFormat,
    ContentModelTable,
...
/**
 * Apply table format to specified table
 * @param table The table to apply format to
 * @param newFormat @optional The format to apply. When not specified, apply default format and existing format from table metadata
 * @param keepCellShade @optional When pass true, if a table cell has customized shade color (mostly applied by setTableCellShade API)
 * the color will not be overwritten, otherwise all cells shade color will be reset to default
 */
