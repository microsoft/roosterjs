import { updateTableCellMetadata } from 'roosterjs-content-model-editor';
 ...
 * @param cell The cell to set background color
 * @param color New background color
 * @param isColorOverride @optional When pass true, this color is treated as color override. applyTableFormat API can skip override color if want
 * @param applyToSegments @optional When pass true, segment color of the table cell will also apply to cell's format color
 */
