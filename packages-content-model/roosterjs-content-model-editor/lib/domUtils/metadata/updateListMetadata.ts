...
import { createMetadataApplier } from './createMetadataApplier';
 ...
 * @internal
 */
export const listItemMetadataApplier = createMetadataApplier<
    ListMetadataFormat,
    ContentModelListItemFormat
 ...
 * @internal
 */
export const listLevelMetadataApplier = createMetadataApplier<
    ListMetadataFormat,
    ContentModelListItemLevelFormat
>((metadata, format, context) => {
    const depth = context.listFormat.nodeStack.length - 2; // Minus two for the parent element and convert length to index
