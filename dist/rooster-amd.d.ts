// Type definitions for roosterjs (Version 7.1.2)
 ...
 * Editor plugin event interface
 */
export type PluginEvent = BeforePasteEvent | ContentChangedEvent | ExtractContentEvent | PluginDomEvent | EditorReadyEvent | BeforeDisposeEvent;
...
export function applyTextStyle(container: Node, styler: (node: HTMLElement) => any, from?: NodePosition, to?: NodePosition): void;
 ...
 */
export function createRange(node: Node, endNode?: Node): Range;
 ...
 */
export function createRange(start: NodePosition, end?: NodePosition): Range;
