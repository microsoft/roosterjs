...
var LinkInlineElement_1 = __webpack_require__(34);
...
var convertInlineCss_1 = __webpack_require__(69);
exports.convertInlineCss = convertInlineCss_1.default;
var fromHtml_1 = __webpack_require__(20);
exports.fromHtml = fromHtml_1.default;
var getComputedStyle_1 = __webpack_require__(18);
...
var isBlockElement_1 = __webpack_require__(30);
...
var Undo_1 = __webpack_require__(36);
...
var snapshotUtils_1 = __webpack_require__(37);
...
function isIntersectWithNodeRange(node, range) {
    var startPosition = node.compareDocumentPosition(range.start.node);
    var endPosition = node.compareDocumentPosition(range.end.node);
    var targetPositions = [
        0 /* Same */,
        16 /* ContainedBy */,
        8 /* Contains */,
...
var SelectionRange_1 = __webpack_require__(79);
...
var CursorData_1 = __webpack_require__(27);
exports.CursorData = CursorData_1.default;
var getNodeAtCursor_1 = __webpack_require__(7);
...
var toggleBullet_1 = __webpack_require__(53);
...
var getTagOfNode_1 = __webpack_require__(13);
var isDocumentPosition_1 = __webpack_require__(6);
var isEditorPointAfter_1 = __webpack_require__(16);
...
Object.defineProperty(exports, "__esModule", { value: true });
var getSelection_1 = __webpack_require__(25);
...
Object.defineProperty(exports, "__esModule", { value: true });
var editorPointEquals_1 = __webpack_require__(29);
var isDocumentPosition_1 = __webpack_require__(6);
var isEditorPointAfter_1 = __webpack_require__(16);
...
Object.defineProperty(exports, "__esModule", { value: true });
var roosterjs_editor_types_1 = __webpack_require__(4);
var getSelection_1 = __webpack_require__(25);
var hasFocus_1 = __webpack_require__(26);
var isRangeInContainer_1 = __webpack_require__(39);
function select(core, arg1, arg2, arg3, arg4) {
    ...
    if (arg1 instanceof Range) {
        ...
        var selectionRangeBase = void 0;
        if (arg1.start && arg1.end) {
            selectionRangeBase = arg1;
        }
        else if (arg1.node) {
            selectionRangeBase = roosterjs_editor_types_1.SelectionRangeBase.create(roosterjs_editor_types_1.Position.create(arg1), arg2 && arg2.node ? roosterjs_editor_types_1.Position.create(arg2) : null);
        }
        else if (arg1 instanceof Node) {
            var start = void 0;
            var end = void 0;
            if (arg2 == undefined) {
                start = roosterjs_editor_types_1.Position.create(arg1, roosterjs_editor_types_1.Position.Before);
                end = roosterjs_editor_types_1.Position.create(arg1, roosterjs_editor_types_1.Position.After);
            }
            else {
        ...
        rawRange = roosterjs_editor_types_1.SelectionRangeBase.toRange(core.document, selectionRangeBase);
    }
...
Object.defineProperty(exports, "__esModule", { value: true });
var getLiveRange_1 = __webpack_require__(9);
var hasFocus_1 = __webpack_require__(26);
    ...
    if (firstNode) {
        if (firstNode.nodeType == 3 /* Text */) {
            ...
            if (isVoidHtmlElement_1.default(firstNode)) {
                ...
                select_1.default(core, firstNode, roosterjs_editor_types_1.Position.Before);
            }
            else {
...
Object.defineProperty(exports, "__esModule", { value: true });
var DefaultShortcut_1 = __webpack_require__(59);
...
var ContentEditFeatures_1 = __webpack_require__(54);
...
Object.defineProperty(exports, "__esModule", { value: true });
var UndoSnapshots_1 = __webpack_require__(78);
var snapshotUtils_1 = __webpack_require__(37);
var KEY_BACKSPACE = 8;
var KEY_DELETE = 46;
var KEY_SPACE = 32;
...
function updateSelectionToCursorMarkers(editor) {
    ...
    if (startMarker && endMarker) {
        editor.select(startMarker, roosterjs_editor_types_1.Position.After, endMarker, roosterjs_editor_types_1.Position.Before);
    }
}
...
function insertNodeAtSelection(core, node, option) {
    ...
    if (rawRange) {
        ...
        var clonedRange = roosterjs_editor_types_1.SelectionRange.create(rawRange);
        ...
        if (option.updateCursor && nodeForCursor) {
            select_1.default(core, nodeForCursor, roosterjs_editor_types_1.Position.After);
        }
        else {
...
function replaceRangeWithNode(editor, range, node, exactMatch) {
    ...
    if (exactMatch) {
        editor.select(node, roosterjs_editor_types_1.Position.After);
    }
    return true;
}
...
Object.defineProperty(exports, "__esModule", { value: true });
var createEditor_1 = __webpack_require__(58);
...
Object.defineProperty(exports, "__esModule", { value: true });
var roosterjs_editor_plugins_1 = __webpack_require__(28);
var roosterjs_editor_core_1 = __webpack_require__(2);
/**
...
Object.defineProperty(exports, "__esModule", { value: true });
var EditorCore_1 = __webpack_require__(61);
var Undo_1 = __webpack_require__(36);
var applyInlineStyle_1 = __webpack_require__(80);
var attachDomEvent_1 = __webpack_require__(81);
var BrowserData_1 = __webpack_require__(23);
var focus_1 = __webpack_require__(24);
...
var getSelection_1 = __webpack_require__(25);
var hasFocus_1 = __webpack_require__(26);
var insertNode_1 = __webpack_require__(42);
var select_1 = __webpack_require__(15);
        ...
        this.onKeyPress = function () {
            ...
            if (selectionRange.collapsed &&
                ...
                if (!blockElement) {
                    ...
                    var focusOffset = selectionRange.start.offset;
                    ...
                    _this.select(roosterjs_editor_types_1.Position.normalize(roosterjs_editor_types_1.Position.create(focusNode, focusOffset)));
                }
            }
        };
...
function calcDefaultFormat(node, baseFormat) {
    ...
    var computedStyle = roosterjs_editor_dom_2.getComputedStyle(node);
    return {
...
Object.defineProperty(exports, "__esModule", { value: true });
var DefaultInlineElementResolver_1 = __webpack_require__(64);
var NodeInlineElement_1 = __webpack_require__(8);
...
exports.default = SelectionRangeBase;
var SelectionRange = {
    create: createRange,
};
exports.SelectionRange = SelectionRange;
function createRangeBase(start, end) {
    end = end || start;
    return {
        start: start,
        end: end,
...
function createRange(rawRange) {
    return __assign({}, SelectionRangeBase.create(Position_1.default.create(rawRange.startContainer, rawRange.startOffset), Position_1.default.create(rawRange.endContainer, rawRange.endOffset)), { rawRange: rawRange });
}
function toRange(document, selectionRangeBase) {
...
function applyInlineStyleToCollapsedSelection(core, styler) {
    ...
    styler(element);
    insertNode_1.default(core, element);
    ...
    select_1.default(core, element, roosterjs_editor_types_1.Position.End);
}
...
function applyInlineStyleToNonCollapsedSelection(core, styler) {
    ...
    if (startNode && endNode) {
        select_1.default(core, startNode, roosterjs_editor_types_1.Position.Before, endNode, roosterjs_editor_types_1.Position.After);
    }
}
// Apply inline style to current selection
function applyInlineStyle(core, styler) {
    focus_1.default(core);
    var range = getLiveRange_1.default(core);
    if (range) {
...
function createLink(editor, link, altText, displayText) {
    ...
    if (url) {
        ...
        var normalizedUrl = linkData ? linkData.normalizedUrl : applyLinkPrefix(url);
        var originalUrl = linkData ? linkData.originalUrl : url;
        var anchor = null;
        editor.addUndoSnapshot();
        ...
        editor.addUndoSnapshot();
        editor.triggerContentChangedEvent("CreateLink" /* CreateLink */, anchor);
    }
}
...
function toggleBold(editor) {
    editor.focus();
    execFormatWithUndo_1.default(editor, function () { return editor.getDocument().execCommand('bold', false, null); });
}
...
function toggleItalic(editor) {
    editor.focus();
    execFormatWithUndo_1.default(editor, function () { return editor.getDocument().execCommand('italic', false, null); });
}
...
function toggleStrikethrough(editor) {
    editor.focus();
    execFormatWithUndo_1.default(editor, function () {
        return editor.getDocument().execCommand('strikeThrough', false, null);
    });
}
...
function toggleSubscript(editor) {
    editor.focus();
    execFormatWithUndo_1.default(editor, function () { return editor.getDocument().execCommand('subscript', false, null); });
}
...
function toggleSuperscript(editor) {
    editor.focus();
    execFormatWithUndo_1.default(editor, function () { return editor.getDocument().execCommand('superscript', false, null); });
}
...
function toggleUnderline(editor) {
    editor.focus();
    execFormatWithUndo_1.default(editor, function () { return editor.getDocument().execCommand('underline', false, null); });
}
                    ...
                    if (listElement == listElement.parentElement.firstChild) {
                        ...
                        document_1.defaultView.requestAnimationFrame(function () {
                            if (_this.editor) {
                                ...
                                _this.editor.select(br, roosterjs_editor_types_1.Position.After);
                            }
                        });
                    }
                }
            ...
            if (node_1 && node_1 != blockQuoteElement) {
                ...
                if (node_1.parentNode == blockQuoteElement && this.shouldToggleState(event, node_1)) {
                    ...
                    roosterjs_editor_api_1.execFormatWithUndo(this.editor, function () {
                        ...
                        _this.editor.select(node_1, roosterjs_editor_types_1.Position.Before);
                    });
                }
            }
        }
...
Object.defineProperty(exports, "__esModule", { value: true });
var CustomData_1 = __webpack_require__(55);
;
...
Object.defineProperty(exports, "__esModule", { value: true });
var LevelLists_1 = __webpack_require__(56);
;
...
var ImageResizePlugin = /** @class */ (function () {
    ...
    ImageResizePlugin.prototype.select = function (target) {
        ...
        target.contentEditable = 'false';
        this.editor.select(this.resizeDiv, roosterjs_editor_types_1.Position.After);
    };
