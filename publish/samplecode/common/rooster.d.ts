// Type definitions for roosterjs (Version 6.9.4)
...
declare namespace roosterjs {
    ...
    type InsertImageHandler = (editor: Editor, imageFile: File) => void;
    ...
    class Paste implements EditorPlugin {
         ...
         */
        constructor(useDirectPaste?: boolean, htmlPropertyCallbacks?: SanitizeHtmlPropertyCallback, insertImageHandler?: InsertImageHandler);
        initialize(editor: Editor): void;
        dispose(): void;
        onPluginEvent(event: PluginEvent): void;
        private onPaste;
