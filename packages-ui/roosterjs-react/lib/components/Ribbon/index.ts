...
export { increaseFontSize } from './buttons/increaseFontSize';
export { decreaseFontSize } from './buttons/decreaseFontSize';
export { textColor } from './buttons/textColor';
export { backgroundColor } from './buttons/backgroundColor';
